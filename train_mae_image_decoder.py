...
log_path = os.path.join(log_path,'save/{}_train_task-{}_shot-{}_mae[{}]_image_compolement_FT[{}]_global[{}]_encoder_lr{}_adam-2-cls-100-{}-N-10'.format(
                            params.dataset,params.train_n_episode,params.n_shot,params.model,params.ft,params.global_pool,params.lr,time.strftime('%Y-%m-%d_%H-%M-%S', time.localtime())))
...
def main():
    ...
    if params.model == 'vit_base_patch16':
        ...
        # checkpoint = torch.load('/home/jiangweihao/code/MAE_fsl/ViT-B-16.pt')
    else:
    ...
    schedule = torch.optim.lr_scheduler.CosineAnnealingLR(optimizer, T_max = 100, eta_min = 1e-5)     # eta_min = 1e-4  新增 T_max =  50
